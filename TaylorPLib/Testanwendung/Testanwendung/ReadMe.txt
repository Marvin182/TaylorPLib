========================================================================
    KONSOLENANWENDUNG: Testanwendung-Projektübersicht
========================================================================

Diese Testanwendung-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre Testanwendung-Anwendung besteht.


Testanwendung.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "Testanwendung.pch und eine 
