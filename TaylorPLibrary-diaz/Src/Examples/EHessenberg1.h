...
#ifndef EHESSENBERG1_H_
#define EHESSENBERG1_H_

#include "../IDExample.h"					/**< Abstract base class. */

class EHessenberg1 : public IDExample	// the class EHessenberg1 inherits from the class IDExample
{
	public:
		/**
		 ...
		 * 
		 */
		EHessenberg1( void ) : IDExample( 3, 4, 1.0, "EHessenberg1" )
		{
		}
