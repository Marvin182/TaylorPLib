...
#ifndef EHESSENBERG2_H_
#define EHESSENBERG2_H_

#include "../IDExample.h"					/**< Abstract base class. */

class EHessenberg2 : public IDExample	// the class EHessenberg2 inherits from the class IDExample
{
	public:
		/**
		 ...
		 * 
		 */
		EHessenberg2( void ) : IDExample( 3, 4, 1.0, "EHessenberg2" )
		{
		}
